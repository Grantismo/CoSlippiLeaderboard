...
export function Row({ rank, player }: Props) {
  ...
  return (
    <tr className="bg-white border-b hover:bg-indigo-300"
      ...
      <td className="text-2xl text-black md:px-6 md:py-4 p-1 whitespace-nowrap">
        #{rank}
      </td>
      <td className="md:px-6 md:py-4 p-1 whitespace-nowrap flex flex-col">
      ...
      <td className="text-xl text-gray-900 md:px-6 md:py-4 p-1 whitespace-nowrap">
        {Math.floor(player.rankedNetplayProfile.ratingOrdinal)}
      </td>
      <td className="text-sm text-gray-900 md:px-6 md:py-4 p-1 whitespace-nowrap">
        {player.rankedNetplayProfile.characters.map((c) => c.character).join(', ')}
      </td>
      <td className="text-xl md:px-6 md:py-4 p-1 whitespace-nowrap">
